...
import { confimSelector } from "store/selectors/cart"
import { fetchConfim } from "store/actions/cart/ordersActions"
...
class CartSteps extends Component {
   state = {
      ...
      confimCustomer: initialState.confimCustomer,
                        ...
                        <CustomerResult  {...customer}>
                           ...
                           <Input
                              ...
                              {confimCustomer.timerVisible && (
                                 <>Запросить код повторно можно через <Timer maxSeconds={3} onTimeEnd={this.handleTimeEnd} /> сек.</>
                              )}
